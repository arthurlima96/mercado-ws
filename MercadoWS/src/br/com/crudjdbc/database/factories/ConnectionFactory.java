...
public abstract class ConnectionFactory {
	...
	private static final String CONNECTION_CONFIGURATION_FILE = "database-config.properties";
	...
	private static String getConnectionDriver() {
		...
		try {
			...
			properties.load(ConnectionFactory.class.getClassLoader().getResourceAsStream(CONNECTION_CONFIGURATION_FILE));
